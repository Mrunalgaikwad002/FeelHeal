export default function HowItWorks() {
  return (
    <section id="how" className="py-16">
      <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] items-center gap-6 md:gap-10">
        {/* Left decorative image */}
        <div className="hidden md:block">
          <img src="/bunny-cute%20(1).gif" alt="Cute bunny" className="w-full h-auto rounded-3xl" style={{border: 0, outline: 'none', boxShadow: 'none'}} />
        </div>

        <div>
          <h2 className="text-2xl md:text-3xl font-semibold text-center md:text-left" style={{color: "var(--feelheal-purple)"}}>How FeelHeal works</h2>
          <p className="text-center md:text-left text-black/80 mt-2 mb-10">Three gentle steps to go from overwhelmed to okay.</p>
