  ...
  return (
    <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 border border-white/20 shadow-lg h-full flex flex-col card-hover">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          onClick={addGoal}
          className="text-3xl hover:scale-110 transition-transform font-bold"
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="space-y-2">
                {getActiveGoals().map((goal) => (
                  <div key={goal.id} className="flex items-center space-x-3 p-3 rounded-lg bg-white/50">
                    <button
              ...
              {goals.length > 3 && (
                <p className="text-sm text-gray-500 mt-2 text-center mt-auto">
